...
router.get("/", async (req, res) => {
  try {
    ...
    if (minPrice || maxPrice) {
      ...
      if (maxPrice) query.price.$lte = Number(maxPrice); // lte - Lesser than or equal to
    }
...
// @desc Retrieve latest 8 products as per Created date
// @access Public
...
// @desc Get the product with given ID
// @access Public
